...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      {
        find: '@managers',
        replacement: path.resolve(__dirname, './src/modules/managers'),
      },
      {
        find: '@manager-components',
        replacement: path.resolve(__dirname, './src/modules/managers/components'),
      },
      { find: '@users', replacement: path.resolve(__dirname, './src/modules/users') },
      {
        find: '@user-components',
        replacement: path.resolve(__dirname, './src/modules/users/components'),
      },
    ],
  },
});
